      ...
      <nav className="sidebar-nav-tree">
        ...
        <div className="nav-category">
          ...
          >
            ...
            <span className="nav-label">Medium-Range (D+1..D+10)</span>
            <span className="nav-alert-pill" style={{ background: "#0ea5e9" }}>D+10</span>
          </button>
        ...
        <div className="nav-category">
          ...
          >
            ...
            <span className="nav-label">Historical Replay</span>
          </button>
